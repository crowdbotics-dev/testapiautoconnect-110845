...
## Project Structure
    ...
    ├── testapiautoconnect_110845  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_110845`
...
2. Clone this repo and `cd testapiautoconnect_110845`
